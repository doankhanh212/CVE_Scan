...
class BasicPipeline:
    ...
    def __init__(self, config: dict, logger=None, progress_cb=None, host_result_cb=None, stop_event=None):
        ...
        # Year window to keep CVEs recent (e.g., last 5 years). 0/None disables.
        self.cve_year_window = int(config.get("cve_year_window", 5))
        ...
        self.host_discovery = HostDiscovery(
            ...
            retries=config.get("ping_retries", 2),
